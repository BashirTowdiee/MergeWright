...
Item: PR 61 readiness check.

Scan:
- Planning workspace was missing.
- Open PR: 61 Add TUI run list pane.
- CI: success on commit 8349f094b10c8a7a272720bc1f91a36ee18ec4de.
...
Item: PR 61 merge-ready check.

Scan:
- Planning workspace exists on the PR branch.
- Open PR: 61 Add TUI run list pane.
- CI: success on commit f01bc0b9c30ae30c22f21db3ab25281b26f01d29.
- PR state: open and mergeable.
...
Item: Evidence manifest schema alignment slice.
...
Item: PR 69 merge-ready check and merge record.

Scan:
- Planning workspace exists on main.
- Recent PR scanned: 69 Align evidence manifest schema with roadmap.
- PR 69 merged successfully before this planning update.
...
Item: Optional evidence manifest reader slice.
